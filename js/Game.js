class Game {
  ...
  start() {
    ...
    cars = [car1, car2];
    semillas = new Group();  ///crear semillas grupo
    fuels = new Group();
  ...
  shootsemilla(){
    semilla = createSprite(150, width / 2, 50, 20)
    semilla.y = player.y - 20
    semilla.addImage(semillaImg)
    semilla.scale = 0.12
    semilla.velocityY = -7
    semillaGroup.add(semilla)
  }
